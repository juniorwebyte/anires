...
import MobileReturnHelp from "@/components/mobile-return-help"
...
export default function ClaimPage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 bg-black text-white relative overflow-hidden">
              ...
              <div className="mt-2 text-sm text-red-200">
                ...
                <ul className="list-disc list-inside mt-1">
                  ...
                  <li>
                    ...
                    <span className="font-mono bg-black/30 px-1 rounded">anires.org</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      {/* Componente de ajuda para dispositivos móveis */}
      <MobileReturnHelp />
